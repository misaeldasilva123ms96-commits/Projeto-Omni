...
**Companion:** [`integration-matrix.md`](./integration-matrix.md) (endpoint inventory and risk notes). **UI shell:** [`ui-architecture.md`](./ui-architecture.md) (Phase 3 layout and primitives). **Cognitive rail:** [`cognitive-panels.md`](./cognitive-panels.md) (Phase 4).  
