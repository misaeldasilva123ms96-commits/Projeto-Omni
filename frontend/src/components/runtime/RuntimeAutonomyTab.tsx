import type { RuntimeAutonomyStatus } from '../../lib/runtimeTypes'
...
export function RuntimeAutonomyTab({ data }: RuntimeAutonomyTabProps) {
  if (!data) {
    return (
      <div>
  ...
  return (
    <div className="space-y-4">
      <p className="text-xs italic text-slate-400">
        Modo somente leitura — nenhuma ação autônoma executada.
      </p>
