...
assert.match(runtimePanel, /safeDebugPayload/, 'runtime panel must expose sanitized debug payload')
assert.match(runtimePanel, /sanitizeRuntimeDebugPayload/, 'runtime panel debug payload must be sanitized')
