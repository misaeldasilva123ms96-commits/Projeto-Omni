...
const omniTopbar = read('src/components/shell/OmniTopbar.tsx')
const omniSidebar = read('src/components/shell/OmniSidebar.tsx')
const omniRightInspector = read('src/components/shell/OmniRightInspector.tsx')

assert.match(omniShell, /role="main"/, 'main content must have role="main"')
assert.match(omniShell, /role="navigation"/, 'sidebar must have role="navigation"')
assert.match(omniShell, /role="region"/, 'inspector must have role="region"')
assert.match(omniShell, /aria-label="Sidebar"/, 'sidebar must have aria-label')
assert.match(omniShell, /aria-label="Runtime inspector"/, 'inspector must have aria-label')
assert.match(omniShell, /aria-hidden="true"/, 'decorative backgrounds must be hidden')
assert.match(omniShell, /href="#main-content"/, 'must have skip-to-content link')
assert.match(omniShell, /id="main-content"/, 'main must have id for skip-link target')
assert.match(omniTopbar, /aria-label="Application header"/, 'topbar must have aria-label')
assert.match(omniSidebar, /aria-label="Expand sidebar"/, 'sidebar collapse button must have aria-label')
assert.match(omniSidebar, /aria-label="Collapse sidebar"/, 'sidebar expand button must have aria-label')
assert.match(omniRightInspector, /aria-expanded/, 'inspector toggle must have aria-expanded')
assert.match(omniRightInspector, /aria-label="Inspector panel"/, 'inspector panel must have aria-label')
assert.match(omniMobileNav, /role="tablist"/, 'mobile nav must have role="tablist"')
assert.match(omniMobileNav, /role="tab"/, 'mobile nav buttons must have role="tab"')
assert.match(omniMobileNav, /aria-selected/, 'mobile nav must have aria-selected')
