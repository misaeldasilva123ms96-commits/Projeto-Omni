...
def build_task_envelope(*, user_id: str, session_id: str, task_id: str, response: str) -> dict[str, Any]:
    return {
        ...
        "links": {
            ...
            "inspect_milestones": {"task_id": task_id, "session_id": session_id},
            "inspect_patch_sets": {"task_id": task_id, "session_id": session_id},
            "inspect_verification": {"task_id": task_id, "session_id": session_id},
            "inspect_pr_summary": {"task_id": task_id, "session_id": session_id},
...
def build_task_status(*, run_id: str, checkpoint: dict[str, Any]) -> dict[str, Any]:
    return {
        ...
        "operator_links": {
            ...
            "inspect_milestones": {"run_id": run_id},
            "inspect_patch_sets": {"run_id": run_id},
            "inspect_verification": {"run_id": run_id},
            "inspect_pr_summary": {"run_id": run_id},
