...
class EvidenceMemoryStore:
    ...
    def record_evidence(
        ...
        *,
        ...
        clean_evidence = {
            "file_evidence": bool(evidence.get("file_evidence")),
            "runtime_evidence": bool(evidence.get("runtime_evidence")),
            "test_evidence": bool(evidence.get("test_evidence")),
            "dependency_evidence": bool(evidence.get("dependency_evidence")),
        }
        entry = {
